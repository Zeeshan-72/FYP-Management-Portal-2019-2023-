...
class InternalGroupMarksheet extends StatefulWidget {
  @override
  _InternalGroupMarksheetState createState() => _InternalGroupMarksheetState();
}

class _InternalGroupMarksheetState extends State<InternalGroupMarksheet> {
  ...
  Future<void> fetchDocumentsFromCollectionGroup() async {
    ...
    final collectionGroup =
        firestoreInstance.collectionGroup('Internal-evaluation');
