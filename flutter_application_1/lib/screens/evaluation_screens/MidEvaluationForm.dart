...
class MidEvaluationForm extends StatefulWidget {
  final DocumentSnapshot documentSnapshot;

  MidEvaluationForm({Key? key, required this.documentSnapshot})
      : super(key: key);

  @override
  State<MidEvaluationForm> createState() => _MidEvaluationFormState();
}

class _MidEvaluationFormState extends State<MidEvaluationForm> {
                                  ...
                                  Container(
                                      ...
                                      child: Column(
                                        crossAxisAlignment:
                                            CrossAxisAlignment.start,
                                        children: [
                                          Text('Proposal Document (5 Points)',
                                              style: TextStyle(
                                                  decoration:
                                                      TextDecoration.underline,
                                                  color: Colors.black,
                                          ...
                                          Text(
                                              '- Submission and presentation of proposal',
                                              style: TextStyle(
                                                color: Colors.black,
                                                fontSize: 16,
                                              )),
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                Padding(
                                                  ...
                                                  child: Container(
                                                    child: _groupproposalerrorMessage !=
                                                            null
                                                        ? Text(
                                                            _groupproposalerrorMessage,
                                                            style: TextStyle(
                                  ...
                                  Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                              '- Completion of Assigned Tasks Throughout Semester',
                                              style: TextStyle(
                                                color: Colors.black,
                                                fontSize: 16,
                                              )),
                                                    ...
                                                    child: Row(
                                                      ...
                                                      children: [
                                                        ...
                                                        Flexible(
                                                          child: Slider(
                                                            value:
                                                                _task_completion_mem1, //current value
                                                            onChanged: (double
                                                                newValue) {
                                                              setState(() {
                                                      ...
                                                      child: Row(
                                                        ...
                                                        children: [
                                                          ...
                                                          Flexible(
                                                            child: Slider(
                                                              value:
                                                                  _task_completion_mem2, //current value
                                                              onChanged: (double
                                                                  newValue) {
                                                                setState(() {
                                                      ...
                                                      child: Row(
                                                        ...
                                                        children: [
                                                          ...
                                                          Flexible(
                                                            child: Slider(
                                                              value:
                                                                  _task_completion_mem3, //current value
                                                              onChanged: (double
                                                                  newValue) {
                                                                setState(() {
                                  ...
                                  Padding(
                                    ...
                                    child: Container(
                                      child: _grouppresentationerrorMessage !=
                                              null
                                          ? Text(_grouppresentationerrorMessage,
                                              style: TextStyle(
                                                  fontSize: 12,
                                                  color: Color.fromARGB(
                                                      255, 212, 33, 20)))
...
// ----------------------------- Group Details -------------------------- //
                                            ...
                                            "group-proposal": _group_proposal,
                                            ...
                                            "task-completion-mem1":
                                                _task_completion_mem1,
                                            "task-completion-mem2":
                                                _task_completion_mem2,
                                            "task-completion-mem3":
                                                _task_completion_mem3,

                                            // ----------------------- Others --------------------------------//

                                            "pervecentage": percentage,
                                            "overall-status": _overall_status,
                                            "code-genuineness":
                                                _code_genuineness,
                                            "documentaion-improvement":
