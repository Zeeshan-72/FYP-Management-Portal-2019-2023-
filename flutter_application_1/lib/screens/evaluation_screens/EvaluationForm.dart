...
final List<Map<String, dynamic>> users = [
  ...
  {"userId": "RndCDn7CRKRz7uvzysR89Iga07f1", "name": "Dr. Toqeer Mahmood"},
...
class EvaluationForm2 extends StatefulWidget {
  final DocumentSnapshot documentSnapshot;

  EvaluationForm2({Key? key, required this.documentSnapshot}) : super(key: key);

  @override
  State<EvaluationForm2> createState() => _EvaluationForm2State();
}

class _EvaluationForm2State extends State<EvaluationForm2> {
...
// ---------------------- Feedback  -------------------------- //
  ...
  bool _commentssliderInteracted = false;
                                              ...
                                              child: RichText(
                                                text: TextSpan(
                                                  children: <TextSpan>[
                                                    TextSpan(
                                                        text:
                                                            'FYP Assessment (Internal): 7th Semester ',
                                                        style: TextStyle(
                                                            color: Colors.black,
                                                            fontSize: 26,
                                                            fontWeight:
...
//  //----------------------------------- Documentation (Introduction) -------------------------- // Slider 1,
                                          ...
                                          Container(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  Text(
                                                      'Introduction and Literature Review:  (10 Points) *',
                                                      style: TextStyle(
                                                          decoration:
                                                              TextDecoration
                                                                  .underline,
...
//  //----------------------------------- Documentation (Design) -------------------------- // Slider 3,
                                          ...
                                          Container(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  Text(
                                                      'Software Design Specification:  (25 Points) *',
                                                      style: TextStyle(
                                                          decoration:
                                                              TextDecoration
                                                                  .underline,
...
//  //----------------------------------- Documentation (Objective achievement) -------------------------- // Slider ,
                                          ...
                                          Container(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  Text(
                                                      'Kindly give your honest feedback and remarks for improvement:',
                                                      style: TextStyle(
                                                        color: Colors.black,
                                                        fontSize: 16,
                                                      )),
                                          ...
                                          Container(
                                              ...
                                              child: Padding(
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    Text(
                                                        'Points for Improvement in Documentation *',
                                                        style: TextStyle(
                                                          color: Colors.black,
                                                          fontSize: 17,
                                                        )),
                                        ...
                                        children: [
                                          ElevatedButton(
                                              ...
                                              onPressed: () {
                                                ...
                                                //       widget.documentSnapshot[
                                                //           'main-supervisor'],
                                                //   "supervisory-evaluation": '0',
                                                //   "internal-evaluation": '0',
                                                //   "total-marks": '',
                                                //   "grade": ''
                                                // };
                                                // DocumentReference docrefMem1 =
                                                ...
                                                if (!_introsliderInteracted &&
                                                    !_SRSsliderInteracted &&
                                                    !_designsliderInteracted &&
                                                    !_testingsliderInteracted &&
                                                    !_attendancesliderInteracted &&
                                                    !_GUIsliderInteracted &&
                                                    !_objectivesliderInteracted &&
                                                    !_presentationsliderInteracted &&
                                                    !_understandingsliderInteracted &&
                                                    !_commentssliderInteracted) {
                                                  setState(() {
                                                    _SRSerrorMessage =
                                                ...
                                                if (formKey.currentState!
                                                  ...
                                                  var evaluator1_results = FirebaseFirestore
                                                      .instance
                                                      .collection(
                                                          "/Evaluations/evaluations/Internal")
                                                      .doc(
                                                          'internal-evaluators')
                                                      .collection(
                                                          snapshot.data.name)
...
// ----------------------------- Group Details -------------------------- //
                                                  ...
                                                  double
                                                      internal_percentage_mem1 =
                                                      (40 / 100) * results_mem1;
                                                  double
                                                      internal_percentage_mem2 =
                                                      (40 / 100) * results_mem2;
                                                  double
                                                      internal_percentage_mem3 =
                                                      (40 / 100) * results_mem3;
                                                  ...
                                                  // -----------------------------------Evaluator  2 Collection ------------------
//                                           var evaluator2_results = FirebaseFirestore
//                                               .instance
//                                               .collection(
//                                                   "/Evaluations/evaluations/Internal")
...
//----------- Documentation  Sliders (Individual)----------- //
  ...
  Future<UserData> getUserData() async {
    ...
    // var userId = 'vHqYdIQminUb7R6aHP5f2IAc4oQ2';
    var userId = user!.uid;
