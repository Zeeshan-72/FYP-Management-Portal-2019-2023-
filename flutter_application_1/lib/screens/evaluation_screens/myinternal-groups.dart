...
class MyInternalGroups2 extends StatefulWidget {
  @override
  _MyInternalGroups2State createState() => _MyInternalGroups2State();
}

class _MyInternalGroups2State extends State<MyInternalGroups2> {
