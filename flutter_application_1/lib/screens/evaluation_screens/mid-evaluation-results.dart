...
class MidEvaluationResults extends StatefulWidget {
  ...
  @override
  State<MidEvaluationResults> createState() => _MidEvaluationResultsState();
}

class _MidEvaluationResultsState extends State<MidEvaluationResults> {
                      ...
                      return ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          int semester_evaluation = int.parse(
                              ...
                              int.parse(groupdocument['group-taskcompletion']
                                  .toString());
                ...
                pw.Table.fromTextArray(
                  ...
                  data: <List<String>>[
                    ...
                    <String>[
                      ...
                      'Proposal Document',
                      '5',
                      snap['group-proposal'].toString()
                    ],
                    <String>[
                      '2',
                      'Introduction & Literature Review',
                      '5',
                      snap['group-intro'].toString()
                    ],
                    <String>[
                      '3',
                      'Software Requirement Specification',
                      '15',
                      snap['group-SRS'].toString()
                    ],
                    <String>[
                      '4',
                      'Software Design Specification',
                      '10',
                      snap['group-design'].toString()
                    ],
                    <String>[
                      '5',
                      'Objectives Achievement',
                      '20',
                      snap['group-objectives'].toString()
                    ],
                    <String>['', 'Total Marks', '45', '$results'],
                  ],
                ),
                pw.SizedBox(
                  height: 30,
