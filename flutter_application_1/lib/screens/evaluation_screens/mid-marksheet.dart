...
class MidMarksheet extends StatefulWidget {
  @override
  _MidMarksheetState createState() => _MidMarksheetState();
}

class _MidMarksheetState extends State<MidMarksheet> {
          ...
          if (snapshot.hasData) {
            return StreamBuilder(
                stream: FirebaseFirestore.instance
                    ...
                    .where("main-supervisor", isEqualTo: snapshot.data.name)
                    .snapshots(),
