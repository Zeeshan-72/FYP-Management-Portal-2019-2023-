...
class EvaluationResults extends StatefulWidget {
  ...
  @override
  State<EvaluationResults> createState() => _EvaluationResultsState();
}

class _EvaluationResultsState extends State<EvaluationResults> {
...
_createPDF(
    var snap, var results, var sum_mem1, var sum_mem2, var sum_mem3) async {
  String getCurrentDate() {
    var date = DateTime.now().toString();
                ...
                pw.Table.fromTextArray(
                  ...
                  data: <List<String>>[
                    ...
                    <String>[
                      ...
                      snap['regno1'],
                      snap['individual-code-understanding-mem1'].toString(),
                      snap['individual-presentation-mem1'].toString(),
                    ],
                    <String>[
                      snap['mem2'],
                      snap['regno2'],
                      snap['individual-code-understanding-mem2'].toString(),
                      snap['individual-presentation-mem2'].toString(),
                    ],
                    <String>[
                      snap['mem3'],
                      snap['regno3'],
                      snap['individual-code-understanding-mem3'].toString(),
                      snap['individual-presentation-mem3'].toString(),
                    ],
                  ],
                ),
