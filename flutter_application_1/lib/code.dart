...
import 'package:flutter_application_1/student_screens/approved.dart';
...
class _CodeState extends State<Code> {
  ...
  List<String> proposal1_Approval = [];

  List<String> proposal1_Rejection = [];
    ...
    return Scaffold(
      ...
      body: StreamBuilder(
          stream: FirebaseFirestore.instance
              ...
              // .orderBy('fyp-id')
              .where('main-supervisor', isEqualTo: 'Mr. Waqar Ahmad')
              .snapshots(),
          builder:
                ...
                children: [
                  ...
                  ListView.builder(
                      ...
                      itemBuilder: (BuildContext context, int index) {
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    InkWell(
                                        onTap: () {
                                          provider.toggleApproval(document.id);
                                          ...
                                          setState(() {
                                            ...
                                            if (proposal1_Approval.contains(
                                                storedocs[index].toString())) {
                                              proposal1_Approval.remove(
                                                  storedocs[index].toString());
                                            } else {
                                              proposal1_Approval.add(
                                                  storedocs[index].toString());
                                            }
                                          });
                                        },
                                        ...
                                        child: Container(
                                          ...
                                          decoration: BoxDecoration(
                                              color:
                                                  provider.isExist(document.id)
                                                      ? Colors.green
                                                      : Colors.grey[200],

                                              //  proposal1_Approval
                                              //         .contains(storedocs[index]
                                              //             .toString())
                                              //
                                              borderRadius:
                                          ...
                                          child: Center(
                                            child: Text(
                                              proposal1_Approval.contains(
                                                      storedocs[index]
                                                          .toString())
                                                  ? 'Approve'
                                                  : 'Approved',
                                              style: TextStyle(
                                                  color: proposal1_Approval
                                                          .contains(
                                                              storedocs[index]
                                                                  .toString())
                                                      ? Colors.white
                                    ...
                                    InkWell(
                                        onTap: () {
                                          ...
                                          setState(() {
                                            if (proposal1_Rejection.contains(
                                                storedocs[index].toString())) {
                                              proposal1_Rejection.remove(
                                                  storedocs[index].toString());
                                            } else {
                                              proposal1_Rejection.add(
                                                  storedocs[index].toString());
                                            }
                                          });
                                        },
                                ...
                                //         } else {
                                //           proposal1_Approval
                                //               .add(storedocs[index].toString());

                                //           var approval = FirebaseFirestore
                                //               .instance
                                //               .collection('Convenor')
                                //               .doc('classes')
                                //               .collection(
                                ...
                                //       width: 100,
                                //       decoration: BoxDecoration(
                                //           color: proposal1_Approval.contains(
                                //                   storedocs[index].toString())
                                //               ? Colors.green
                                //               : Colors.grey[200],
                                //           borderRadius:
                        ...
                        return Text(proposal1_Approval.toString());
                      }),
                ],
              ),
            );
