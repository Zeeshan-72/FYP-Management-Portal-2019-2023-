...
class SupervisorPasswordChange extends StatefulWidget {
  const SupervisorPasswordChange({super.key});

  @override
  State<SupervisorPasswordChange> createState() =>
      _SupervisorPasswordChangeState();
}

class _SupervisorPasswordChangeState extends State<SupervisorPasswordChange> {
  ...
  Widget build(BuildContext context) {
    resetPassword() async {
      ...
      Navigator.pushReplacement(
          context, MaterialPageRoute(builder: (_) => SupervisorLogin()));
    }
