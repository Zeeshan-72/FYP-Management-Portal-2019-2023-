...
class my_internal_groups_marksheet extends StatefulWidget {
  @override
  State<my_internal_groups_marksheet> createState() =>
      _my_internal_groups_marksheetState();
}

class _my_internal_groups_marksheetState
    extends State<my_internal_groups_marksheet> {
            ...
            if (snapshot.hasData) {
              return StreamBuilder<QuerySnapshot>(
                stream: FirebaseFirestore.instance
                    ...
                    .where('meevaluator', isEqualTo: snapshot.data.name)
                    .snapshots(),
                      ...
                      child: Container(
                        ...
                        child: Column(
                            ...
                            children: [
                              Center(
                                child: Text(
                                  'Internal Semester Evaluation Results',
