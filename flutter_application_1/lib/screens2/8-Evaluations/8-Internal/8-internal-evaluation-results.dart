...
class FinalInternalEvaluationResults extends StatefulWidget {
  final DocumentSnapshot snap;

  FinalInternalEvaluationResults({
    Key? key,
    required this.snap,
  }) : super(key: key);

  @override
  State<FinalInternalEvaluationResults> createState() =>
      _FinalInternalEvaluationResultsState();
}

class _FinalInternalEvaluationResultsState
    extends State<FinalInternalEvaluationResults> {
              ...
              if (snapshot.hasData) {
                return StreamBuilder(
                    stream: FirebaseFirestore.instance
                        ...
                        .doc(widget.snap.id)
                        .collection('final-internal-evaluation')
                        .snapshots(),
                ...
                pw.Table.fromTextArray(
                  ...
                  data: <List<String>>[
                    ...
                    <String>[
                      ...
                      'Application GUI',
                      '10',
                      snap['group-GUI'].toString()
                    ],
                    <String>[
                      '7',
                      'Short Video',
                      '5',
                      snap['group-video'].toString()
                    ],
                    <String>['', 'Total Marks', '60', '$results'],
                  ],
                ),
                pw.SizedBox(
                  height: 30,
