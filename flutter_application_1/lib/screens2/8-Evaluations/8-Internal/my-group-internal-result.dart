...
class MyGroupInternalResult extends StatefulWidget {
  @override
  State<MyGroupInternalResult> createState() => _MyGroupInternalResultState();
}

class _MyGroupInternalResultState extends State<MyGroupInternalResult> {
