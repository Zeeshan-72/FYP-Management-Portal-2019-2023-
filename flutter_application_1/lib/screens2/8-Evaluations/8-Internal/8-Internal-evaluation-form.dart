...
class FinalInternalEvaluationForm extends StatefulWidget {
  final DocumentSnapshot documentSnapshot;

  FinalInternalEvaluationForm({Key? key, required this.documentSnapshot})
      : super(key: key);

  @override
  State<FinalInternalEvaluationForm> createState() =>
      _FinalInternalEvaluationFormState();
}

class _FinalInternalEvaluationFormState
    extends State<FinalInternalEvaluationForm> {
...
//  //----------------------------------- Documentation (SRS) -------------------------- // Slider 2,
                                  ...
                                  Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Text(
                                              'Software Requirement Specification:  (18 Points) *',
                                              style: TextStyle(
                                                  decoration:
                                                      TextDecoration.underline,
                                                  color: Colors.black,
...
//  //----------------------------------- Documentation (Design) -------------------------- // Slider 3,
                                  ...
                                  Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Text(
                                              'Software Design Specification:  (12 Points) *',
                                              style: TextStyle(
                                                  decoration:
                                                      TextDecoration.underline,
                                                  color: Colors.black,
                                  ...
                                  Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Text(
                                              'Application and Code (Understanding)  (25 Points)',
                                              style: TextStyle(
                                                  decoration:
                                                      TextDecoration.underline,
                                                  color: Colors.black,
                                  ...
                                  Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          RadioListTile(
                                            title: Text(
                                                "Presentable for External Evaluation (Minor Revisions)"),
                                            value: "Presentable",
                                          ...
                                          RadioListTile(
                                            title: Text(
                                                "Not Presentable for External Evaluation (Major Revisions)"),
