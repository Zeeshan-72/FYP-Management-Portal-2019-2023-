...
class ExternalEvaluationForm extends StatefulWidget {
  final DocumentSnapshot documentSnapshot;

  ExternalEvaluationForm({Key? key, required this.documentSnapshot})
      : super(key: key);

  @override
  State<ExternalEvaluationForm> createState() => _ExternalEvaluationFormState();
}

class _ExternalEvaluationFormState extends State<ExternalEvaluationForm> {
...
//----------- Documentation  Sliders (Individual)----------- //
  ...
  double _individual_documentation_mem1 = 0.0;
  double _individual_documentation_mem2 = 0.0;
  double _individual_documentation_mem3 = 0.0;
...
// ---------------------- Feedback  -------------------------- //
  ...
  bool _individualdocumentationslider = false;
  ...
  var _individualdocumentationerrormessage;
...
//  //----------------------------------- Documentation (Introduction) -------------------------- // Slider 1,
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                ...
                                                Flexible(
                                                  child: Slider(
                                                    value:
                                                        _individual_documentation_mem1, //current value
                                                    onChanged:
                                                        (double newValue) {
                                                      setState(() {
                                                        _individual_documentation_mem1 =
                                                            newValue;
                                                        _individualdocumentationslider =
                                                            true;
                                                        _individualdocumentationerrormessage =
                                                            null;
                                                      });
                                                    },
                                                    min: 0,
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  ...
                                                  Flexible(
                                                    child: Slider(
                                                      value:
                                                          _individual_documentation_mem2, //current value
                                                      onChanged:
                                                          (double newValue) {
                                                        setState(() {
                                                          _individual_documentation_mem2 =
                                                              newValue;
                                                          _individualdocumentationslider =
                                                              true;
                                                          _individualdocumentationerrormessage =
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  ...
                                                  Flexible(
                                                    child: Slider(
                                                      value:
                                                          _individual_documentation_mem3, //current value
                                                      onChanged:
                                                          (double newValue) {
                                                        setState(() {
                                                          _individual_documentation_mem3 =
                                                              newValue;
                                                          _individualdocumentationslider =
                                                              true;
                                                          _individualdocumentationerrormessage =
                                        ...
                                        Padding(
                                          padding: const EdgeInsets.all(8.0),
                                          child: Container(
                                            child: _individualdocumentationerrormessage !=
                                                    null
                                                ? Text(
                                                    _individualdocumentationerrormessage,
                                                    style: TextStyle(
                                  ...
                                  Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Text(
                                              'Application and Code (Understanding)  (15 Points)',
                                              style: TextStyle(
                                                  decoration:
                                                      TextDecoration.underline,
                                                  color: Colors.black,
                                  ...
                                  Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Text(
                                            'Presentation and Display:  (5 Points) *',
                                            style: TextStyle(
                                                decoration:
                                                    TextDecoration.underline,
                                                color: Colors.black,
                                  ...
                                  Container(
                                      ...
                                      child: Column(
                                        crossAxisAlignment:
                                            CrossAxisAlignment.start,
                                        children: [
                                          Text('Information of Evaluators',
                                              style: TextStyle(
                                                  decoration:
                                                      TextDecoration.underline,
                                                  fontStyle: FontStyle.italic,
...
//
                                          ...
                                          // double external_percentage_mem1 =
                                          //     (30 / 100) * results_mem1;
                                          // double external_percentage_mem2 =
                                          //     (30 / 100) * results_mem2;
                                          // double external_percentage_mem3 =
                                          //     (30 / 100) * results_mem3;

                                          // -----------------------------------Evaluator  1 Collection ------------------
                                          var evaluator1_results = FirebaseFirestore
                                              .instance
                                              .collection(
...
// ----------------------------- Group Details -------------------------- //
                                            ...
                                            "external-group-results": results,
                                            ...
                                            // "external-percentage-mem1":
                                            //     external_percentage_mem1,
                                            // "external-percentage-mem2":
                                            //     external_percentage_mem2,
                                            // "external-percentage-mem3":
                                            //     external_percentage_mem3,
                                          ...
                                          querySnapshot.docs
                                            ...
                                            // Add new fields to the document without overwriting existing fields
                                            documentRef.update({
                                              "fyp-id": widget
                                                  .documentSnapshot["fyp-id"],
                                              "mem1": widget
                                                  .documentSnapshot['mem1'],
                                              "mem2": widget
                                                  .documentSnapshot['mem2'],
                                              "mem3": widget
                                                  .documentSnapshot['mem3'],
                                              "regno1": widget
                                                  .documentSnapshot['regno1'],
                                              "regno2": widget
                                                  .documentSnapshot['regno2'],
                                          ...
                                          final DocumentReference
                                              documentRef_1 = FirebaseFirestore
                                                  .instance
                                                  .collection(
                                          ...
                                          final DocumentSnapshot snapshot =
                                              await documentRef_1.get();
                                          Map<String, dynamic> documentData =
                                              snapshot.data()
                                                  as Map<String, dynamic>;
                                          documentData['external-result'] =
                                              results_mem1;
                                          await documentRef_1.set(documentData,
                                              SetOptions(merge: true));

                                          final DocumentReference
                                              documentRef_2 = FirebaseFirestore
                                                  .instance
                                                  .collection(
                                                      '/Convenor/classes/BS Information Technology/groups/8th-Semester-Results')
                                                  .doc(widget.documentSnapshot[
                                          ...
                                          final DocumentSnapshot snapshot2 =
                                              await documentRef_2.get();
                                          Map<String, dynamic> documentData2 =
                                              snapshot2.data()
                                                  as Map<String, dynamic>;
                                          documentData2['external-result'] =
                                              results_mem2;
                                          await documentRef_2.set(documentData2,
                                              SetOptions(merge: true));

                                          final DocumentReference
                                              documentRef_3 = FirebaseFirestore
                                                  .instance
                                                  .collection(
                                                      '/Convenor/classes/BS Information Technology/groups/8th-Semester-Results')
                                                  .doc(widget.documentSnapshot[
                                          ...
                                          final DocumentSnapshot snapshot3 =
                                              await documentRef_3.get();
                                          Map<String, dynamic> documentData3 =
                                              snapshot3.data()
                                                  as Map<String, dynamic>;
                                          documentData3['external-result'] =
                                              results_mem3;
                                          await documentRef_3.set(documentData3,
                                              SetOptions(merge: true));
