...
class BSIT_MID_EVALUATION extends StatefulWidget {
  @override
  _BSIT_MID_EVALUATIONState createState() => _BSIT_MID_EVALUATIONState();
}

class _BSIT_MID_EVALUATIONState extends State<BSIT_MID_EVALUATION> {
            ...
            child: Container(
              ...
              child: Column(
                  ...
                  children: [
                          ...
                          DataRow(cells: [
                            DataCell(Text('1',
                                style: GoogleFonts.roboto(
                                    fontSize: 14,
                                    fontWeight: FontWeight.w600))),
                            DataCell(Text('Proposal Document',
                                style: GoogleFonts.roboto(
                                    fontSize: 14,
                                    fontWeight: FontWeight.w600))),
                            DataCell(Text('5',
                                style: GoogleFonts.roboto(
                                    ...
                                    fontWeight: FontWeight.w600))),
                            DataCell(Text(
                                groupdocument['group-proposal'].toString(),
                                style: GoogleFonts.roboto(
                                    fontSize: 14,
                                    fontWeight: FontWeight.w600))),
                          ]),
                          ...
                          DataRow(cells: [
                            DataCell(Text('3',
                                style: GoogleFonts.roboto(
                                    fontSize: 14,
                                    fontWeight: FontWeight.w600))),
                            DataCell(Text('Software Requirement Specifications',
                                style: GoogleFonts.roboto(
                                    fontSize: 14,
                                    fontWeight: FontWeight.w600))),
                            DataCell(
                    ...
                    Padding(
                        padding: const EdgeInsets.only(left: 50, right: 30),
                        child: Text(groupdocument['documentaion-improvement'],
                            style: GoogleFonts.roboto(
                                fontSize: 14, fontWeight: FontWeight.w600)))
                  ]),
            ),
