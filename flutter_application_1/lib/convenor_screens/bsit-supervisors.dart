...
class SupervisorsList extends StatelessWidget {
  const SupervisorsList({super.key});
                    ...
                    child: Container(
                      ...
                      child: DataTable(
                        ...
                        rows: snapshot.data!.docs
                          ...
                          int index = snapshot.data!.docs.indexOf(document);
                          ...
                          return DataRow(
                            ...
                            cells: [
                              DataCell(
                                Text(document['fyp-id'],
                                    style: GoogleFonts.roboto(
                                        fontSize: 14,
                                        fontWeight: FontWeight.w400)),
                              ),
                              DataCell(Text(document['main-supervisor'],
                                  style: GoogleFonts.roboto(
                                      fontSize: 14,
                                      fontWeight: FontWeight.w400))),
                              DataCell(
                                Text(document['co-supervisor'],
                                    style: GoogleFonts.roboto(
                                        fontSize: 14,
                                        fontWeight: FontWeight.w400)),
                              ),
