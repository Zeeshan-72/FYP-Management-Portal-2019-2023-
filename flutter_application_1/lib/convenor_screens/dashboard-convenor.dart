...
class ConvenorDashboard extends StatefulWidget {
  @override
  State<ConvenorDashboard> createState() => _ConvenorDashboardState();
}

class _ConvenorDashboardState extends State<ConvenorDashboard> {
    ...
    return InkWell(
      ...
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => ConvenorDashboard2(
...
// class Convenor_Dashboard extends StatefulWidget {
//   @override
//   State<Convenor_Dashboard> createState() => _Convenor_DashboardState();
// }

// class _Convenor_DashboardState extends State<Convenor_Dashboard> {
//   GlobalKey<ScaffoldState> _drawerKey = GlobalKey();
