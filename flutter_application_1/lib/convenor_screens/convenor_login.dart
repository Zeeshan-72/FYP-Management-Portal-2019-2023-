...
class ConvenorLogin extends StatefulWidget {
  ConvenorLogin({super.key});

  @override
  State<ConvenorLogin> createState() => _ConvenorLoginState();
}

final _auth = FirebaseAuth.instance;

class _ConvenorLoginState extends State<ConvenorLogin> {
  ...
  Future<void> login() async {
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        if (currentUserID == "A5Yb79Mx1oYCD4yv6iBVpERJMP33") {
          // Allow login
