...
class BSIT_MID_EVALUATION_8 extends StatefulWidget {
  @override
  _BSIT_MID_EVALUATION_8State createState() => _BSIT_MID_EVALUATION_8State();
}

class _BSIT_MID_EVALUATION_8State extends State<BSIT_MID_EVALUATION_8> {
                      ...
                      child: Column(
                        children: [
                          Container(
                            ...
                            child: Text('Supervisor Evaluation',
                                style: GoogleFonts.roboto(
                                                                  ...
                                                                  children: [
                                                                    GestureDetector(
                                                                      onTap:
                                                                        ...
                                                                        var supervisory_results_mem1 = FirebaseFirestore
                                                                            .instance
                                                                            .collection(
                                                                        ...
                                                                        var supervisory_results_mem2 = FirebaseFirestore
                                                                            .instance
                                                                            .collection(
                                                                                "/Convenor/classes/BS Information Technology/groups/7th-Semester-Results")
                                                                            .doc(groupdocument[
                                                                        ...
                                                                        var supervisory_results_mem3 = FirebaseFirestore
                                                                            .instance
                                                                            .collection(
                                                                                "/Convenor/classes/BS Information Technology/groups/7th-Semester-Results")
                                                                            .doc(groupdocument[
  ...
  void getDocument(var groupdocument) async {
    String documentId = 'zeeshan';
    QuerySnapshot querySnapshot = await FirebaseFirestore.instance
        .collection('supervisor')
        .doc('supervisor')
        .collection(groupdocument['main-supervisor'])
        .doc('groups')
  ...
  Future<void> deleteDocumentFromCollectionGroup(var document) async {
    FirebaseFirestore.instance
        .collectionGroup('random')
        .where('fyp-id', isEqualTo: document);
  ...
  void _deletedata(var groupdocument) async {
    try {
      await FirebaseFirestore.instance
          .collection('supervisorr')
          .doc('supervisor')
          .collection(groupdocument['main-supervisor'])
          .doc('groups')
          .collection('main-supervision')
  ...
  _ViewInternalResult(var groupdocument) {
    ...
    var results_mem3 = groupdocument['group-intro'] +
        ...
        groupdocument['overall-attendance-mem3'];
    // int semester_evaluation =
    //     int.parse(groupdocument['group-proposal'].toString()) +
    //         int.parse(groupdocument['group-taskcompletion'].toString());

    // int semester_evaluation_mem1 =
    //     int.parse(groupdocument['group-taskcompletion'].toString()) +
    //         int.parse(groupdocument['group-proposal'].toString()) +
    //         int.parse(groupdocument['overall-attendance-mem1'].toString());

    // int semester_evaluation_mem2 =
    //     int.parse(groupdocument['group-taskcompletion'].toString()) +
    //         int.parse(groupdocument['group-proposal'].toString()) +
    //         int.parse(groupdocument['overall-attendance-mem2'].toString());

    // int semester_evaluation_mem3 =
    //     int.parse(groupdocument['group-taskcompletion'].toString()) +
    //         int.parse(groupdocument['group-proposal'].toString()) +
    //         int.parse(groupdocument['overall-attendance-mem3'].toString());

    // int individual_evaluation_mem1 = int.parse(
    //         groupdocument['individual-code-understanding-mem1'].toString()) +
    //     int.parse(groupdocument['overall-attendance-mem1'].toString());

    // int individual_evaluation_mem2 = int.parse(
    //         groupdocument['individual-code-understanding-mem2'].toString()) +
    //     int.parse(groupdocument['overall-attendance-mem2'].toString());

    // int individual_evaluation_mem3 = int.parse(
    //         groupdocument['individual-code-understanding-mem3'].toString()) +
    //     int.parse(groupdocument['overall-attendance-mem3'].toString());

    // double semester_percentage_mem1 = (15 / 100) * semester_evaluation_mem1;
    // double semester_percentage_mem2 = (15 / 100) * semester_evaluation_mem2;
    // double semester_percentage_mem3 = (15 / 100) * semester_evaluation_mem3;

    // double mid_percentage_mem1 = (45 / 100) * results_mem1;
    // double mid_percentage_mem2 = (45 / 100) * results_mem2;
    // double mid_percentage_mem3 = (45 / 100) * results_mem3;

    // double totalresults_mem1 = (semester_percentage_mem1 + mid_percentage_mem1);
    // double totalresults_mem2 = (semester_percentage_mem2 + mid_percentage_mem2);
    // double totalresults_mem3 = (semester_percentage_mem3 + mid_percentage_mem3);
    return SafeArea(
      child: Center(
          child: Container(
        decoration: BoxDecoration(
            ...
            child: Container(
              ...
              child: Column(
                  ...
                  children: [
                    Center(
                      child: Text(
                        'Supervisor Evaluation Results (8th)',
                      ...
                      child: DataTable(
                          ...
                          rows: [
                            DataRow(cells: [
                              DataCell(Text('1',
                                  style: GoogleFonts.roboto(
                                      fontSize: 14,
                                      fontWeight: FontWeight.w600))),
                              DataCell(Text('Introduction & Literature Review',
                                  style: GoogleFonts.roboto(
                                      fontSize: 14,
                                      fontWeight: FontWeight.w600))),
                              DataCell(Text('5',
                              ...
                              // ))
                              DataCell(Text(
                                  groupdocument['group-intro'].toString(),
                                  style: GoogleFonts.roboto(
                                      fontSize: 14,
                                      fontWeight: FontWeight.w600))),
                            ]),
                            DataRow(cells: [
                              ...
                              DataCell(
                                Text(groupdocument['group-SRS'].toString(),
                                    style: GoogleFonts.roboto(
                                        fontSize: 14,
                                        fontWeight: FontWeight.w600)),
                              ),
                            ...
                            DataRow(cells: [
                              DataCell(Text('3',
                                  style: GoogleFonts.roboto(
                                      fontSize: 14,
                                      fontWeight: FontWeight.w600))),
                              DataCell(Text('Software Design Specification',
                                  style: GoogleFonts.roboto(
                                      fontSize: 14,
                                      fontWeight: FontWeight.w600))),
                              DataCell(Text('10',
                                  style: GoogleFonts.roboto(
                                      ...
                                      fontWeight: FontWeight.w600))),
                              DataCell(Text(
                                  groupdocument['group-design'].toString(),
                                  style: GoogleFonts.roboto(
                                      fontSize: 14,
                                      fontWeight: FontWeight.w600))),
                            ]),
                            DataRow(cells: [
                              DataCell(Text('4',
                                  style: GoogleFonts.roboto(
                                      fontSize: 14,
                                      fontWeight: FontWeight.w600))),
                              DataCell(Text('Objective Achievement',
                                  style: GoogleFonts.roboto(
                                      fontSize: 14,
                                      fontWeight: FontWeight.w600))),
                              DataCell(Text('10',
                                  style: GoogleFonts.roboto(
                                      ...
                                      fontWeight: FontWeight.w600))),
                              DataCell(Text(
                                  groupdocument['group-objectives'].toString(),
                                  style: GoogleFonts.roboto(
                                      fontSize: 14,
                                      fontWeight: FontWeight.w600))),
                            ]),
                            DataRow(cells: [
                              DataCell(Text('5',
                                  style: GoogleFonts.roboto(
                                      fontSize: 14,
                                      fontWeight: FontWeight.w600))),
                              DataCell(Text('Application Security',
                                  style: GoogleFonts.roboto(
                                      fontSize: 14,
                                      fontWeight: FontWeight.w600))),
                              DataCell(Text('5',
                                  style: GoogleFonts.roboto(
                                      ...
                                      fontWeight: FontWeight.w600))),
                              DataCell(Text(
                                  groupdocument['group-security'].toString(),
                                  style: GoogleFonts.roboto(
                                      fontSize: 14,
                                      fontWeight: FontWeight.w600))),
                            ]),
                            DataRow(cells: [
                              DataCell(Text('5',
                                  style: GoogleFonts.roboto(
                                      fontSize: 14,
                                      fontWeight: FontWeight.w600))),
                              DataCell(Text('Application and Code (GUI)',
                                  style: GoogleFonts.roboto(
                                      fontSize: 14,
                                      fontWeight: FontWeight.w600))),
                              DataCell(Text('5',
                                  style: GoogleFonts.roboto(
                                      ...
                                      fontWeight: FontWeight.w600))),
                              DataCell(Text(
                                  groupdocument['group-GUI'].toString(),
                                  style: GoogleFonts.roboto(
                                      fontSize: 14,
                                      fontWeight: FontWeight.w600))),
                            ]),
                            DataRow(cells: [
                              ...
                              DataCell(Text('5',
                                  style: GoogleFonts.roboto(
                                      ...
                                      fontWeight: FontWeight.w600))),
                              DataCell(Text(
                                  groupdocument['group-video'].toString(),
                                  style: GoogleFonts.roboto(
                                      fontSize: 14,
                                      fontWeight: FontWeight.w600))),
                            ]),
                      ...
                      child: DataTable(
                        ...
                        rows: [
                          DataRow(cells: [
                            ...
                            DataCell(Text('100',
                                style: GoogleFonts.roboto(
                                    fontSize: 14,
                                    fontWeight: FontWeight.w600))),
                            DataCell(Text(results_mem1.toStringAsFixed(0),
                                style: GoogleFonts.roboto(
                                    fontSize: 14,
                                    fontWeight: FontWeight.w600))),
                          ]),
                          DataRow(cells: [
                            ...
                            DataCell(Visibility(
                              visible: !isFieldEmpty2,
                              child: Text(results_mem2.toStringAsFixed(0),
                                  style: GoogleFonts.roboto(
                                      fontSize: 14,
                                      fontWeight: FontWeight.w600)),
                            )),
                          ...
                          DataRow(cells: [
                            ...
                            DataCell(Visibility(
                              visible: !isFieldEmpty3,
                              child: Text(results_mem3.toStringAsFixed(0),
                                  style: GoogleFonts.roboto(
                                      fontSize: 14,
                                      fontWeight: FontWeight.w600)),
                            )),
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          ...
                          Text(groupdocument['code-genuineness'])
                        ],
                      ),
                    ),
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          Text('Overall Status of Project:',
                              style: GoogleFonts.roboto(
                                  fontSize: 14, fontWeight: FontWeight.w900)),
                          SizedBox(
                            width: 20,
                          ),
                          Text(groupdocument['overall-supervisory-status'])
                        ],
                      ),
                    ),
                    SizedBox(
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          ...
                          Expanded(
                            child:
                                Text(groupdocument['documentaion-improvement']),
                          )
                        ],
                      ),
                    ),
