...
class ConvenorSignup extends StatefulWidget {
  ConvenorSignup({super.key});

  @override
  State<ConvenorSignup> createState() => _ConvenorSignupState();
}

final _auth = FirebaseAuth.instance;

class _ConvenorSignupState extends State<ConvenorSignup> {
